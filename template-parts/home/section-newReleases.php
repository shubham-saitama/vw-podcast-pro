<?php
/**
 * Template part for displaying Resources Section
 *
 * @package vw-podcast-pro
 */

$section_hide = get_theme_mod('vw_podcast_pro_new_releases_image_enable');
$single_page_title = get_theme_mod('vw_podcast_pro_nreleases_show_all_btn');
if ('Disable' == $section_hide) {
  return;
}
if (get_theme_mod('vw_podcast_pro_our_resource_btns_bgcolor', '')) {
  $services_back = 'background-color:' . esc_attr(get_theme_mod('vw_podcast_pro_our_resource_btns_bgcolor', '')) . ';';
} elseif (get_theme_mod('vw_podcast_pro_our_resource_btns_bgimage', '')) {
  $services_back = 'background-image:url(\'' . esc_url(get_theme_mod('vw_podcast_pro_our_resource_btns_bgimage')) . '\')';
} else {
  $services_back = '';
}
?>

<section id="newReleases" style="<?php echo esc_attr($services_back); ?>" class="<?php //echo esc_attr($img_bg);   ?>">
  <div class="">
    <div class="row">
      ...
      <div class="section-heading">
        ...
        <h3>
          <?php echo get_theme_mod('vw_podcast_pro_new_releases_section_heading'); ?>
        </h3>

        <div class="show-all">
          <a href="<?php echo $single_page_title; ?>"><?php echo get_theme_mod('vw_podcast_pro_nreleases_show_all_text');?></a>
        </div>
      </div>
    </div>
    <?php
